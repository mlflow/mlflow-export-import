"""
Export the entire tracking server - all registered models, experiments, runs and the Databricks notebook associated with the run.
"""
...
def main(output_dir, notebook_formats, use_threads):
    ...
    This exports all registered models, experiments, runs and the Databricks notebook
