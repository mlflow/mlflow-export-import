...
def export_all(output_dir, export_source_tagss=False, notebook_formats=None, use_threads=False):
...
def main(output_dir, export_source_tagss, notebook_formats, use_threads):
    print("Options:")
    for k,v in locals().items():
        print(f"  {k}: {v}")
    export_all(output_dir, export_source_tagss, notebook_formats, use_threads)
