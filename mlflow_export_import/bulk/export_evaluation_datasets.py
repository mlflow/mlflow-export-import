...
def export_evaluation_datasets(
    ...
    try:
        ...
        # Export datasets
        if use_threads:
            results = _export_datasets_threaded(datasets_to_export, output_dir)
        else:
            results = _export_datasets_sequential(datasets_to_export, output_dir)
...
def _export_datasets_sequential(datasets, output_dir):
    """Export datasets sequentially."""
    results = []
...
def _export_datasets_threaded(datasets, output_dir):
    """Export datasets using multithreading."""
...
@click.option("--experiment-ids",
    help="Comma-separated list of experiment IDs to filter datasets. Only used when --datasets is 'all'.",
    type=str,
    required=False
)
