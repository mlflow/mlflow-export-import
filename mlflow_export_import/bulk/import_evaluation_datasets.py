...
def import_evaluation_datasets(
    ...
    try:
        ...
        if use_threads:
            ...
            results = _import_datasets_sequential(dataset_dirs, delete_dataset)
...
def _import_datasets_sequential(dataset_dirs, delete_dataset):
...
def _import_datasets_threaded(dataset_dirs, delete_dataset):
    """Import datasets using multithreading."""
