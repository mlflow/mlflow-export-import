...
def _init_run_test(mlflow_context, run_name = None, model_artifact = "model"):
    _, src_run = create_simple_run(mlflow_context.client_src,
        run_name = run_name,
    ...
    dst_run = copy_run.copy(
        ...
        mlflow_context.client_dst.tracking_uri
    )
