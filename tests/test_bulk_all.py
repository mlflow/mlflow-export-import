...
def _run_test(mlflow_context, compare_func, export_metadata_tags=False, use_threads=False):
    ...
    export_all(mlflow_context.output_dir, export_metadata_tags=export_metadata_tags, notebook_formats=notebook_formats, use_threads=use_threads)
...
def test_exp_with_metadata_tags_threads(mlflow_context):
    _run_test(mlflow_context, compare_runs, export_metadata_tags=True, use_threads=True)
